...
export default class UserSummaries extends Component {
    ...
    requestList = () => {
        axios.requestList(this, '/user/summarys/my', this.params)
    }
    ...
    handleAddSummary = () => {
        this.props.history.push('/user/createSummary')
    }
    ...
    handleUpdate = () => {
        ...
        if (selectRecord) {
            this.props.history.push(`/user/updateSummary/${selectRecord.id}`)
        }
    }
