...
class UserCreateSummary extends Component {
    constructor(props) {
        super(props)
        this.state = {
            loadSuccess: false,
    ...
    addSummary = (params) => {
        axios.ajax({
            ...
            data: {
                ...
                this.props.history.push("/user/summaries")
    ...
    render() {
        ...
        return <div className='create_task_container'>
            <Card title='发布组会小结'>
                {loadSuccess ? <CreateTaskForm formList={Utils.addKeyToFormList(Scheme.formList)}
...
export default withRouter(UserCreateSummary)