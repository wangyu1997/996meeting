...
class AdminReports extends Component {
    ...
    handleAddReport = () => {
        this.props.history.push('/user/createReport')
    }
    ...
    requestList = () => {
        axios.requestList(this, '/user/per_meets/my', this.params)
    }
    ...
    handleUpdate = () => {
        ...
        if (selectRecord) {
            this.props.history.push(`/user/updateReport/${selectRecord.id}`)
        }
    }
